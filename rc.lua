...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86Display", function ()
        awful.util.spawn("xrandr --output HDMI2 --auto --left-of eDP1 && xrandr --output DP1 --auto --right-of eDP1",
                         false) end),
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     -- We need to enable size_hints_honor b/c it causes issues with gnome-terminal.wrapper
                     -- see https://github.com/awesomeWM/awesome/issues/1340
                     -- We could also try to use version 4.2 (but that needs a compilation from source)
